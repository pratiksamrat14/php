...
<style>
body {
    background-image   : url(images/wellness_615.jpg);
...
<div id="dock-container">
  ...
  <div id="dock">
    <div class="backurl" content-type="url" single_click_url="index_en.php?menu=menu4&stb-type=<?php echo $_GET["stb-type"] ?>&browser-version=<?php echo $_GET["browser-version"]?>"></div>
    <ul id="main_menu_ul" style="cursor:pointer;"><li id="1" select="true"><span>Kaya Kalp</span>
        <div content-type="image" single_click_url="kaya-kalp_625.jpg" item="menu1"><img src="images/kaya-kalp_625_icon.png" /><p><img src="images/menu-cover.png" /></p></div>
      </li><li id="2" select="true"><span>Fitness Center</span>
        <div content-type="image" single_click_url="fitness-center_626.jpg" item="menu2"><img src="images/fitness-center_626_icon.png" /><p><img src="images/menu-cover.png" /></p></div>
      </li><li id="3" select="true"><span>Pool</span>
        <div content-type="image" single_click_url="pool_627.jpg" item="menu3"><img src="images/pool_627_icon.png" /><p><img src="images/menu-cover.png" /></p></div>
      </li></ul>
  </div>
