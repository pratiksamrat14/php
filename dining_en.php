...
<style>
body {
    background-image   : url(images/dining_614.jpg);
...
<div id="dock-container">
  ...
  <div id="dock">
    <div class="backurl" content-type="url" single_click_url="index_en.php?menu=menu3&stb-type=<?php echo $_GET["stb-type"] ?>&browser-version=<?php echo $_GET["browser-version"]?>"></div>
    <ul id="main_menu_ul" style="cursor:pointer;"><li id="1" select="true"><span>WelcomeCafe</span>
        <div content-type="image" single_click_url="welcomecafe_622.jpg" item="menu1"><img src="images/welcomecafe_622_icon.png" /><p><img src="images/menu-cover.png" /></p></div>
      </li><li id="2" select="true"><span>Peshawri</span>
        <div content-type="image" single_click_url="peshawri_623.jpg" item="menu2"><img src="images/peshawri_623_icon.png" /><p><img src="images/menu-cover.png" /></p></div>
      </li><li id="3" select="true"><span>Swizzle</span>
        <div content-type="image" single_click_url="swizzle_624.jpg" item="menu3"><img src="images/swizzle_624_icon.png" /><p><img src="images/menu-cover.png" /></p></div>
      </li></ul>
  </div>
