...
<style>
body {
    background-image   : url(images/welcomhotel-bhubaneswar_611.jpg);
...
<div id="dock-container">
  ...
  <div id="dock">
    <div class="backurl" content-type="url" single_click_url="http://portal.zenith/tv/menu.do?previous-selected-menu=cmslink:"></div>
    <ul id="main_menu_ul" style="cursor:pointer;"><li id="1" select="true"><span>Hotel Information</span>
        <div content-type="image" single_click_url="hotelinformation_612.jpg" item="menu1"><img src="images/hotelinformation_612_icon.png" /><p><img src="images/menu-cover.png" /></p></div>
      </li><li id="2" select="true"><span>Accomodation</span>
        <div content-type="url" single_click_url="accomodation_en.php?stb-type=<?php echo $_GET["stb-type"] ?>&browser-version=<?php echo $_GET["browser-version"]?>" item="menu2"><img src="images/accomodation_613_icon.png" /><p><img src="images/menu-cover.png" /></p></div>
      </li><li id="3" select="true"><span>Dining</span>
        <div content-type="url" single_click_url="dining_en.php?stb-type=<?php echo $_GET["stb-type"] ?>&browser-version=<?php echo $_GET["browser-version"]?>" item="menu3"><img src="images/dining_614_icon.png" /><p><img src="images/menu-cover.png" /></p></div>
      </li><li id="4" select="true"><span>Wellness</span>
        <div content-type="url" single_click_url="wellness_en.php?stb-type=<?php echo $_GET["stb-type"] ?>&browser-version=<?php echo $_GET["browser-version"]?>" item="menu4"><img src="images/wellness_615_icon.png" /><p><img src="images/menu-cover.png" /></p></div>
      </li><li id="5" select="true"><span>Business & Banqueting</span>
        <div content-type="url" single_click_url="businessandbanqueting_en.php?stb-type=<?php echo $_GET["stb-type"] ?>&browser-version=<?php echo $_GET["browser-version"]?>" item="menu5"><img src="images/meetings-events_616_icon.png" /><p><img src="images/menu-cover.png" /></p></div>
      </li><li id="6" select="true"><span>Offers</span>
        <div content-type="url" single_click_url="offers_en.php?stb-type=<?php echo $_GET["stb-type"] ?>&browser-version=<?php echo $_GET["browser-version"]?>" item="menu6"><img src="images/offers_628_icon.png" /><p><img src="images/menu-cover.png" /></p></div>
      </li></ul>
  </div>
